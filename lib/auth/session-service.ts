...
import { evaluateSession, selectAvailableSessionSlot, SESSION_POLICY } from '@/modules/identity/contract'
import type { OrganizationRole } from '@/modules/access/contract'
import type { CognitoIdentity, CognitoTokenSet } from './cognito'
import { getAuthConfig } from './config'
import { withAuthTransaction, type DatabaseClient } from './db'
import {
  createSessionSecret,
