import { createApiError, errorResponse, type ApiContractError } from '@/modules/shared/api-contract'
import type { OrganizationRole } from '@/modules/access/contract'
import { requireActor, requireRole } from './actor'
import type { SessionActor } from './session-service'
