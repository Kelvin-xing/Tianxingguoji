...
export function CaseCreateForm({ preselectedStudentId }: { readonly preselectedStudentId?: string }) {
  ...
  if (accessState === 'denied') return <AccessMessage icon="shield" title="無法建立案件" detail="你的帳號目前沒有使用案件工作區的權限。服務端仍會獨立驗證每次保存。" href="/cases" action="返回案件" />
