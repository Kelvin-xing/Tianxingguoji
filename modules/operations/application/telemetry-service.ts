...
import type { AuditEvent } from "../../audit/public.ts";
import {
  ALERT_CATALOGUE_VERSION,
  buildAlertOccurrence,
  type AlertOccurrence,
} from "../domain/alert-catalogue.ts";
import {
  type ProductTelemetryEvent,
} from "../domain/telemetry-contract.ts";
import { buildProductTelemetryEvent } from "../domain/telemetry-policy.ts";
